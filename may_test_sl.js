    ...
    function beforeSubmit(context) {
        try {
            if (context.type === context.UserEventType.CREATE || context.type === context.UserEventType.EDIT) {
                ...
                // Get the internal ID of the current item fulfillment record
                ...
                for (var i = 0; i < linecount; i++) {
                    ...
                    var numSublines = inventoryDetailSublist.getLineCount({
                    ...
                    let searchResults = createItemFulfillmentSearch(arrLotNumber, intUniqueKey)
                    ...
                    newRecord.setSublistValue({
                        ...
                        line: i,
                        value: JSON.stringify(arrXPDate)
                    });
